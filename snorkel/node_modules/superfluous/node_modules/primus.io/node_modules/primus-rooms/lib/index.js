...
function PrimusRooms(primus, options) {
  ...
  primus.join = function join(spark, room, fn) {
    ...
    primus._rooms.task('join', spark, room, sparks, fn);
    return primus;
  };
  ...
  primus.leave = function leave(spark, room, fn) {
    var sparks = primus.connections;
    primus._rooms.task('leave', spark, room, sparks, fn);
    return primus;
  };
  ...
  primus.empty = function empty(room) {
    var sparks = primus.connections;
    return primus._rooms.empty(primus, room, sparks);
  };
