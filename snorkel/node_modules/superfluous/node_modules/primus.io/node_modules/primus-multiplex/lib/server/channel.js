...
Channel.prototype.join = function join(spark, room, fn) {
  var sparks = this.connections;
  if (this._rooms) this._rooms.task('join', spark, room, sparks, fn);
  return this;
};
...
Channel.prototype.leave = function leave(spark, room, fn) {
  var sparks = this.connections;
  if (this._rooms) this._rooms.task('leave', spark, room, sparks, fn);
  return this;
};
 ...
 *
 * @param {Function} fn callback
 * @return {Channel|Array} this or array of client ids
 * @api public
 */
...
Channel.prototype.empty = function empty(room) {
  if (!this._rooms) return this;
  return this._rooms.empty(this, room, this.connections);
};
