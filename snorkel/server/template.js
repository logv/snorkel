...
function render_css_link(stylesheet) {
  ...
  return render_template("helpers/css_link.html.erb", {
...
function render_js_link(script) {
  ...
  return render_template("helpers/js_link.html.erb", {
...
var render_template = function(template, options) {
  var template_data = load_template(template);
...
var js_header = function() {
  ...
  ret += render_template("helpers/js_link.html.erb", {
    path: "/pkg/prelude.js"
  });
...
var css_header = function() {
  var ret = "";
  ret += render_template("helpers/css_link.html.erb", {
...
var add_socket = function(socket) {
  return render_template("helpers/socket.io.html.erb", {
